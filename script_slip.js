...
console.log(pay)
    ...
    $("#payout").html(html6)
    $("#list").html(html)
    $("#qrPrint").attr('src', `https://promptpay.io/0864562536/${amountTax.toFixed(2)}`);
...
function numberWithCommas(x) {
 ...
 function save(){
    ...
    const idRecive = "CR2023-"+new Date().getTime();
    ...
    let a = [{id: idRecive}]
        ...
        let config = {
            ...
            url:'https://script.google.com/macros/s/AKfycbyCQtgP3ZVlbQPHTxSwgmjewnVX2jik0HmVekpSiwhKhtLAiCc8A6N-Ui0zXXf3ZmmlMg/exec?type=2',
            headers: { },
            data : formData
        };
