...
//   showMenuList(menu)
  ...
  let config = {
    ...
    url: 'https://script.google.com/macros/s/AKfycbyCQtgP3ZVlbQPHTxSwgmjewnVX2jik0HmVekpSiwhKhtLAiCc8A6N-Ui0zXXf3ZmmlMg/exec?type=1',
    headers: { },
    data : ""
  };
...
function selectproduct(mid, mname, mprice) {
  ...
  amount_p = sumprice
  document.getElementById("qr").src = "https://promptpay.io/0864562536/"+sumprice
}
